...
const sortStarWarsCharacters = (starWarsArr) => {
  // Solution code here...
  let array =starWarsArr.sort((function(a, b){return b.height - a.height}));
  return array;
...
const listFoods = (recipe) => {
 ...
 let potato = '';
  for (let i=0; i < recipe.ingredients.length;i++){
    ...
    banana = recipe.ingredients[i];

    potato = banana.slice(banana.indexOf(" ")+1);
    
    

    result.push(potato.slice(potato.indexOf(" ")+1));
  }
